...
goog.exportSymbol('proto.electrious.workers.planset.Request', null, global);
/**
 ...
 * @constructor
 */
proto.electrious.workers.planset.Request = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.electrious.workers.planset.Request.repeatedFields_, null);
};
goog.inherits(proto.electrious.workers.planset.Request, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.electrious.workers.planset.Request.displayName = 'proto.electrious.workers.planset.Request';
}
 ...
 * @const
 */
proto.electrious.workers.planset.Request.repeatedFields_ = [3,4,5];
 ...
 * @return {!Object}
 */
proto.electrious.workers.planset.Request.prototype.toObject = function(opt_includeInstance) {
  return proto.electrious.workers.planset.Request.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.electrious.workers.planset.Request} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.electrious.workers.planset.Request.toObject = function(includeInstance, msg) {
  var obj = {
 ...
 * @return {!proto.electrious.workers.planset.Request}
 */
proto.electrious.workers.planset.Request.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.electrious.workers.planset.Request;
  return proto.electrious.workers.planset.Request.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.electrious.workers.planset.Request} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.electrious.workers.planset.Request}
 */
proto.electrious.workers.planset.Request.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.electrious.workers.planset.Request.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.electrious.workers.planset.Request.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.electrious.workers.planset.Request} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.electrious.workers.planset.Request.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getLead();
  if (f != null) {
    writer.writeMessage(
 ...
 */
proto.electrious.workers.planset.Request.prototype.getLead = function() {
...
proto.electrious.workers.planset.Request.prototype.setLead = function(value) {
 ...
 */
proto.electrious.workers.planset.Request.prototype.clearLead = function() {
 ...
 * @return {boolean}
 */
proto.electrious.workers.planset.Request.prototype.hasLead = function() {
 ...
 */
proto.electrious.workers.planset.Request.prototype.getAddress = function() {
...
proto.electrious.workers.planset.Request.prototype.setAddress = function(value) {
 ...
 * Clears the message field making it undefined.
 */
proto.electrious.workers.planset.Request.prototype.clearAddress = function() {
 ...
 * @return {boolean}
 */
proto.electrious.workers.planset.Request.prototype.hasAddress = function() {
 ...
 */
proto.electrious.workers.planset.Request.prototype.getHomeownersList = function() {
...
proto.electrious.workers.planset.Request.prototype.setHomeownersList = function(value) {
 ...
 */
proto.electrious.workers.planset.Request.prototype.addHomeowners = function(opt_value, opt_index) {
 ...
 */
proto.electrious.workers.planset.Request.prototype.clearHomeownersList = function() {
 ...
 */
proto.electrious.workers.planset.Request.prototype.getRoofplatesList = function() {
...
proto.electrious.workers.planset.Request.prototype.setRoofplatesList = function(value) {
 ...
 */
proto.electrious.workers.planset.Request.prototype.addRoofplates = function(opt_value, opt_index) {
 ...
 * Clears the list making it empty but non-null.
 */
proto.electrious.workers.planset.Request.prototype.clearRoofplatesList = function() {
 ...
 */
proto.electrious.workers.planset.Request.prototype.getPanelsList = function() {
...
proto.electrious.workers.planset.Request.prototype.setPanelsList = function(value) {
 ...
 */
proto.electrious.workers.planset.Request.prototype.addPanels = function(opt_value, opt_index) {
 ...
 * Clears the list making it empty but non-null.
 */
proto.electrious.workers.planset.Request.prototype.clearPanelsList = function() {
  this.setPanelsList([]);
};
 ...
 */
proto.electrious.workers.planset.Request.prototype.getRacking = function() {
...
proto.electrious.workers.planset.Request.prototype.setRacking = function(value) {
 ...
 * Clears the message field making it undefined.
 */
proto.electrious.workers.planset.Request.prototype.clearRacking = function() {
 ...
 * @return {boolean}
 */
proto.electrious.workers.planset.Request.prototype.hasRacking = function() {
 ...
 */
proto.electrious.workers.planset.Request.prototype.getPanel = function() {
...
proto.electrious.workers.planset.Request.prototype.setPanel = function(value) {
 ...
 * Clears the message field making it undefined.
 */
proto.electrious.workers.planset.Request.prototype.clearPanel = function() {
 ...
 * @return {boolean}
 */
proto.electrious.workers.planset.Request.prototype.hasPanel = function() {
  return jspb.Message.getField(this, 7) != null;
};


goog.object.extend(exports, proto.electrious.workers.planset);
